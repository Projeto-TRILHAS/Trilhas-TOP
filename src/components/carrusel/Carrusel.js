            ...
            <div className="carousel-inner">
              ...
              <div className="carousel-item active">
                ...
                <div className="carousel-caption d-none d-md-block">
                  <h2 className="Carrusel-text">1er Lugar con {props.trilhas[0].points} Puntos</h2>
              ...
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block">
                <h2 className="Carrusel-text">2do Lugar con {props.trilhas[1].points} Puntos</h2>
              ...
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block">
                <h2 className="Carrusel-text">3er Lugar con {props.trilhas[2].points} Puntos</h2>
